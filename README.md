Перекатился на новую структуру конфига в приватном репозитории
Теперь это лишь история

## Моя nixos конфигурация
...
- [name-snrl/nixos-configuration](https://github.com/name-snrl/nixos-configuration)
