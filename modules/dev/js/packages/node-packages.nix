...
let
  sources = {
    ...
    "isolated-vm-4.6.0" = {
      ...
      version = "4.6.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/isolated-vm/-/isolated-vm-4.6.0.tgz";
        sha512 = "MEnfC/54q5PED3VJ9UJYJPOlU6mYFHS3ivR9E8yeNNBEFRFUNBnY0xO4Rj3D/SOtFKPNmsQp9NWUYSKZqAoZiA==";
      };
    };
    "js-tokens-4.0.0" = {
      name = "js-tokens";
